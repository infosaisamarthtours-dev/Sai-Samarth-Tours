...
function FloatingButtons() {
  ...
  return (
    <div className="hidden md:flex fixed bottom-6 right-6 flex-col gap-3 z-50">
      ...
      <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="bg-[#25D366] text-white p-3 rounded-full shadow-lg hover:bg-[#128C7E] transition-transform hover:-translate-y-1 flex items-center justify-center" aria-label="WhatsApp Us">
