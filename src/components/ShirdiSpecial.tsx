...
export function ShirdiSpecial({ onSelectPackage, onOpenEnquiry }: Props) {
  ...
  return (
    <section className="w-full py-12 md:py-20 bg-[#FBF9F5] border-b border-gray-200" id="shirdi">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <div className="flex flex-wrap justify-center items-center gap-2 sm:gap-4 mt-5">
                ...
                <div className="mt-auto pt-3 border-t border-gray-100 flex flex-col gap-2.5">
                  ...
                  <div className="flex flex-row gap-1.5 w-full pt-0.5">
                    <button 
                      ...
                      className="flex-1 flex items-center justify-center gap-1 bg-white text-[#2563EB] border border-[#2563EB]/40 hover:bg-blue-50 hover:border-[#2563EB] px-1.5 py-2 rounded-lg font-bold text-[11px] transition-all cursor-pointer"
                    >
                    ...
                    <button 
                      ...
                      className="flex-1 flex items-center justify-center gap-1 bg-gradient-to-r from-[#2563EB] to-[#1D4ED8] hover:from-[#F59E0B] hover:to-[#EA580C] text-white px-1.5 py-2 rounded-lg font-bold text-[11px] transition-all shadow-xs active:scale-95 cursor-pointer"
                    >
                      View Details
