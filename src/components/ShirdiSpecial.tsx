                ...
                <div className="mt-auto pt-3 border-t border-gray-100 flex flex-col gap-2.5">
                  ...
                  <div className="flex flex-row gap-1.5 w-full pt-0.5">
                    <button 
                      ...
                      className="flex-1 flex items-center justify-center gap-1 bg-amber-50 text-[#EA580C] border border-[#EA580C]/40 hover:bg-[#EA580C] hover:text-white px-1.5 py-2 rounded-lg font-bold text-[11px] transition-all cursor-pointer"
                    >
                    ...
                    <button 
                      ...
                      className="flex-1 flex items-center justify-center gap-1 bg-gradient-to-r from-[#F97316] to-[#EA580C] hover:from-[#EA580C] hover:to-[#C2410C] text-white px-1.5 py-2 rounded-lg font-bold text-[11px] transition-all shadow-xs active:scale-95 cursor-pointer"
                    >
                      View Details
