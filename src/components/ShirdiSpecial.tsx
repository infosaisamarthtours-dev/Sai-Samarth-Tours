...
export function ShirdiSpecial({ onSelectPackage, onOpenEnquiry }: Props) {
  ...
  return (
    <section className="w-full py-16 md:py-24 bg-white" id="shirdi">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 relative">
        <div className="text-center mb-8 sm:mb-14">
          ...
          {/* Related Topic Feature Badges - Desktop Only */}
          <div className="hidden sm:flex flex-wrap justify-center items-center gap-2 sm:gap-4 mt-6">
            <span className="bg-blue-50 text-[#114088] text-xs font-bold px-3 py-1.5 rounded-full border border-blue-100 flex items-center gap-1.5 shadow-2xs">
            ...
            <span className="bg-blue-50 text-[#114088] text-xs font-bold px-3 py-1.5 rounded-full border border-blue-100 flex items-center gap-1.5 shadow-2xs">
              <span className="text-[#F59E0B]">✓</span> Includes Shani Shingnapur & Triambakeshwar
            </span>
          </div>
