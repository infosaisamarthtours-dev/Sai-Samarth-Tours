...
export function InternationalJourneys({ onSelectPackage, onOpenEnquiry }: Props) {
  ...
  const internationalPackages = internationalIds
  ...
  return (
    <section className="w-full py-16 md:py-24 bg-[#FBF9F5]" id="international">
              ...
              >
                ...
                <div className="relative h-48 w-full overflow-hidden shrink-0">
                  <img 
                    src={pkg.image} 
                    alt={pkg.title} 
                    className={`w-full h-full object-cover absolute inset-0 group-hover:scale-110 transition-transform duration-700 object-center`}
                  />
