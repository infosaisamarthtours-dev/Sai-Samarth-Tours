          ...
          <div className="flex items-center gap-3">
            {socialLinks.map((social, idx) => (
              <a 
                ...
                className="w-9 h-9 rounded-lg bg-white/10 hover:bg-[#F59E0B] border border-white/10 hover:border-[#F59E0B] text-gray-300 hover:text-white flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-sm"
              >
