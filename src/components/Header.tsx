...
export const Header: React.FC<HeaderProps> = ({ onOpenEnquiry }) => {
  ...
  return (
    <header className="w-full flex flex-col z-50 sticky top-0 shadow-md">
      ...
      {/* Top Banner Bar: Tour Guide Announcement & Social Media Icons */}
      <div className="bg-[#0C1F41] text-white w-full px-4 sm:px-8 py-1.5 flex flex-wrap justify-between items-center text-xs border-b border-white/10">
        {/* Left: Human Icon & Tour Guide Badge */}
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1.5 bg-amber-500/20 text-[#F59E0B] px-3 py-0.5 rounded-full border border-amber-500/40 font-semibold tracking-wide">
            <UserCheck className="w-3.5 h-3.5 text-[#F59E0B]" />
            <span>Tour Guide & Manager Available for All Packages</span>
          </div>
        </div>

        {/* Right: Phone & Social Media Icons */}
        <div className="hidden sm:flex items-center gap-4">
          <a href={`tel:+91${siteConfig.phoneTentative}`} className="flex items-center gap-1.5 hover:text-[#F59E0B] transition-colors font-medium">
            <Phone className="w-3.5 h-3.5 text-[#F59E0B]" />
            <span>+91 {siteConfig.phoneTentative}</span>
          </a>
          <span className="text-gray-600">|</span>
          <div className="flex items-center gap-2">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" title="Facebook" className="w-6 h-6 rounded-full bg-white/10 hover:bg-[#2563EB] flex items-center justify-center transition-colors text-white">
            ...
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" title="Instagram" className="w-6 h-6 rounded-full bg-white/10 hover:bg-[#E1306C] flex items-center justify-center transition-colors text-white">
            ...
            <a href="https://wa.me/919483488258" target="_blank" rel="noopener noreferrer" title="WhatsApp" className="w-6 h-6 rounded-full bg-white/10 hover:bg-[#25D366] flex items-center justify-center transition-colors text-white">
            ...
            <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" title="YouTube" className="w-6 h-6 rounded-full bg-white/10 hover:bg-[#FF0000] flex items-center justify-center transition-colors text-white">
      ...
      {/* Main Tier: Logo, Search, Social Icons, CTA */}
      <div className="bg-white w-full px-4 sm:px-8 py-3 flex justify-between items-center border-b border-gray-100">
        ...
        <div className="hidden md:flex flex-1 justify-center relative">
          <div className="w-full max-w-md relative">
            ...
            <input 
              ...
              className="w-full pl-11 pr-4 py-2.5 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#114088] focus:border-transparent text-sm transition-all shadow-sm"
            />
          </div>
        </div>
        ...
        <div className="flex-1 flex justify-end items-center gap-3 sm:gap-5">
          {/* Social Media Icons (Header Tier) */}
          <div className="hidden xl:flex items-center gap-2 mr-1">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" title="Facebook" className="w-8 h-8 rounded-full bg-blue-50 text-[#114088] hover:bg-[#2563EB] hover:text-white flex items-center justify-center transition-all shadow-sm">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" title="Instagram" className="w-8 h-8 rounded-full bg-pink-50 text-[#E1306C] hover:bg-[#E1306C] hover:text-white flex items-center justify-center transition-all shadow-sm">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
            </a>
            <a href="https://wa.me/919483488258" target="_blank" rel="noopener noreferrer" title="WhatsApp" className="w-8 h-8 rounded-full bg-green-50 text-[#25D366] hover:bg-[#25D366] hover:text-white flex items-center justify-center transition-all shadow-sm">
