...
export function PackageDetailsPage() {
  ...
  const defaultWhyUs = pkg.detailedContent?.whyChooseUs || [
    'Handpicked 3-star and luxury AC accommodations close to key attractions',
    'Sanitised private AC vehicles with experienced local drivers',
    'Specialized assistance for senior citizens and VIP Darshan support',
    '24/7 dedicated travel manager for real-time support'
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 -mt-8 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* 2. Detailed Content Session Card */}
